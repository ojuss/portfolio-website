      ...
      <div
        ...
        <div className={"mx-auto w-full max-w-prose"}>
          ...
          <div className="mt-4 pb-12 space-y-4">
           <p className="text-lg">
           <span className="text-pink-400">Six strings with fretboard:</span> I love playing and composing music on acoustic guitar with my friend. Right now, I'm learning fingerstyle, which is a way of playing where you use your fingers instead of a pick. I'm trying to learn the song <br/> <span className="text-blue-300">"No Idea"</span> by Don Toliver.
           </p>
            <p>
